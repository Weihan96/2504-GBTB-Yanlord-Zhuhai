"""Fresh task-owned IFC loader and unchanged public bridge on 9894."""
...
prefs.port=9894;prefs.allow_edits=True
bpy.ops.bonsai_mcp.start_bridge()
assert tool.Ifc.get_path()==path
target=tool.Ifc.get_object(tool.Ifc.get().by_guid("2xmcLzu1rDTeMzRuNxPDyE"))
