"""Fresh task-owned IFC loader and unchanged public bridge on 9895."""
...
prefs.port=9895;prefs.allow_edits=True
bpy.ops.bonsai_mcp.start_bridge()
assert tool.Ifc.get_path()==path
target=tool.Ifc.get_object(tool.Ifc.get().by_guid("2S2c498tb7$gzdukjhCGVQ"))
