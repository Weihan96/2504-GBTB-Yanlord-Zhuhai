"""Fresh task-owned IFC loader and unchanged public bridge on 9892."""
...
prefs.port=9892;prefs.allow_edits=True
bpy.ops.bonsai_mcp.start_bridge()
assert tool.Ifc.get_path()==path
target=tool.Ifc.get_object(tool.Ifc.get().by_guid("3jT4sCgpHC98VSIUdGUNYH"))
