"""Fresh task-owned IFC loader and unchanged public bridge on 9897."""
...
prefs.port=9897;prefs.allow_edits=True
bpy.ops.bonsai_mcp.start_bridge()
assert tool.Ifc.get_path()==path
target=tool.Ifc.get_object(tool.Ifc.get().by_guid("2eX84IyLr8_e34nuOoRPLQ"))
