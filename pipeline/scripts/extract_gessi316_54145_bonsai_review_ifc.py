#!/usr/bin/env python3
"""Extract one Gessi316 54145 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/gessi316-54145/Gessi316-54145-bonsai-isolated.ifc"
GLOBAL_ID = "3jT4sCgpHC98VSIUdGUNYH"
