#!/usr/bin/env python3
"""Extract one Baxter Miami Soft E07 IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/miamisoft-e07/Baxter-Miami-Soft-E07-bonsai-isolated.ifc"
GLOBAL_ID = "1G7iO6CfP64PjummX$qTbt"
...
if product is None:
    raise RuntimeError("Miami Soft E07 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated Miami Soft E07 IFC lost its actual MODEL_VIEW Body representation")
