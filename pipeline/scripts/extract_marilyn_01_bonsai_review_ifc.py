#!/usr/bin/env python3
"""Extract one Baxter Marilyn 01 IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/marilyn-01/Baxter-Marilyn-01-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("Marilyn 01 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated Marilyn 01 IFC lost its actual MODEL_VIEW Body representation")
