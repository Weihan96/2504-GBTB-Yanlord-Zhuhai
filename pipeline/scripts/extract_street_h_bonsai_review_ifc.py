#!/usr/bin/env python3
"""Extract one STREET-H IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/street-h/antoniolupi-Street-H-bonsai-isolated.ifc"
GLOBAL_ID = "2ajpw0I9n1dBypfISg3ejX"
...
if product is None:
    raise RuntimeError("STREET-H representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated STREET-H IFC lost its actual Body representation")
