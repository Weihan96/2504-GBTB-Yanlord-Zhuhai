#!/usr/bin/env python3
"""Extract one Baxter Stone BST03 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/bst03/Baxter-Stone-BST03-bonsai-isolated.ifc"
GLOBAL_ID = "1HZoxe$df4cBb4UXXH5J2S"
...
if product is None:
    raise RuntimeError("BST03 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated BST03 IFC lost its actual MODEL_VIEW Body representation")
