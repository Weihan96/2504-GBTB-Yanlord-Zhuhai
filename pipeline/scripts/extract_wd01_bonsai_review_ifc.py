#!/usr/bin/env python3
"""Extract one Poliform Pivot + Senzafine / WD01 IFC Body for Bonsai rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/wd01/Poliform-Pivot-Senzafine-WD01-bonsai-isolated.ifc"
GLOBAL_ID = "2mPTt7$nvBSAn28I9NWt6T"
...
if product is None:
    raise RuntimeError("WD01 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated WD01 IFC lost its actual Body representation")
