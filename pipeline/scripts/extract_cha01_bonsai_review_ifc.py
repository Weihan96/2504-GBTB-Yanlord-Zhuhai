#!/usr/bin/env python3
"""Extract one Baxter Colette / CHA01 IFC Body for Bonsai review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/cha01/Baxter-Colette-CHA01-bonsai-isolated.ifc"
GLOBAL_ID = "1luHljRzDAhPNXxTDNu7qB"
...
if product is None:
    raise RuntimeError("CHA01 representative was not extracted")
model_body = [
    representation
...
if len(model_body) != 1:
    raise RuntimeError("isolated CHA01 IFC lost its actual MODEL_VIEW Body representation")
