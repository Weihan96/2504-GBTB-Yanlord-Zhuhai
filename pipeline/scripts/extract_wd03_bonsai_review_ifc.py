#!/usr/bin/env python3
"""Extract one Poliform Senzafine / WD03 IFC Body for Bonsai rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/wd03/Poliform-Senzafine-WD03-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("WD03 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated WD03 IFC lost its actual Body representation")
