#!/usr/bin/env python3
"""Generate the RODA Orson 002 / CHA02 review without claiming official CAD."""
...
shared.ARTICLE_NUMBER = "RODA ORSON 002 / CHA02"
shared.GENERATOR = "pipeline/scripts/cha02_review.py"
shared.OFFICIAL_CAD_STATUS = "reserved_area_authentication_required_not_acquired"
shared.OUTPUT_DIR = ROOT / "output/review/highpoly-types/cha02"
...
shared.EXPECTED_DESCRIPTION = "RODA Orson 2"
