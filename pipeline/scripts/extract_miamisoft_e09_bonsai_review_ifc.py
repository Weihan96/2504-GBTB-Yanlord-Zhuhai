#!/usr/bin/env python3
"""Extract one Baxter Miami Soft E09 IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/miamisoft-e09/Baxter-Miami-Soft-E09-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("Miami Soft E09 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated Miami Soft E09 IFC lost its actual MODEL_VIEW Body representation")
