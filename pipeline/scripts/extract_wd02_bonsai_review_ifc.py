#!/usr/bin/env python3
"""Extract one Poliform Senzafine / WD02 IFC Body for Bonsai rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/wd02/Poliform-Senzafine-WD02-bonsai-isolated.ifc"
GLOBAL_ID = "3yuXF4PtnBHgIXDlmXFJ$7"
...
if product is None:
    raise RuntimeError("WD02 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated WD02 IFC lost its actual Body representation")
