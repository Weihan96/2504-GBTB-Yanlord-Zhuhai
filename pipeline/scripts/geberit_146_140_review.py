#!/usr/bin/env python3
"""Generate isolated Geberit 146.140 three-view review with exact official DWG overlays."""
...
OUTPUT_DIR = ROOT / "output/review/highpoly-types/geberit-146-140"
...
PRODUCT_PAGE_ARCHIVE = OUTPUT_DIR / "official-source/geberit-aquaclean-sela-product-page.html"
...
def render_index(manifest):
    ...
    context_cards = "\n".join(
        ...
        for label, svg, preview in (
            ("Plan · instance 0UtU7", "project-context-sanitary-plan-0UtU7yPb10ku4gsbGoM_sp-review.svg", "project-context-sanitary-plan-0UtU7yPb10ku4gsbGoM_sp-review-preview.png"),
            ("Plan · instance 1rhZG", "project-context-sanitary-plan-1rhZG98PPCSxaLeMFLTYb9-review.svg", "project-context-sanitary-plan-1rhZG98PPCSxaLeMFLTYb9-review-preview.png"),
    ...
    content = f'''<!doctype html><html lang="en"><meta charset="utf-8"><title>Geberit 146.140 review</title>
...
<h1>Geberit AquaClean Sela 146.140 native-DWG review</h1><p>Grey = actual IFC Body; black = proxy; blue = exact official 146.140.11.1 G/A/L native DWG. Status: visual review pending; derived IFC write is gated.</p>
<nav><a href="manifest.json">Manifest</a><a href="candidate-representations.json">Candidate paths</a><a href="profile.json">Profile</a><a href="official-native-dwg-linework.json">Official linework</a><a href="official-source/source-access-record.json">Source record</a><a href="official-source/">Official source folder</a><a href="project-context-sanitary-plan.svg">Full project plan</a><a href="project-context-front-elevation.svg">Project front elevation</a><a href="project-context-side-elevation.svg">Project side elevation</a><a href="bonsai-review-manifest.json">Bonsai evidence</a><a href="https://catalog.international.geberit.com/en-GB/product/PRO_942494">Official product page</a></nav>
...
def main():
    ...
    for code, source_record in linework["official_sources"].items():
        if sha256(ROOT / source_record["path"]) != source_record["sha256"]:
            raise RuntimeError(f"Geberit 146.140 official {code} DWG hash mismatch")
    ...
    if (
        ...
        raise RuntimeError("Geberit 146.140 official CDN revalidation gate failed")
    for code, source_record in linework["official_sources"].items():
        ...
        if (
            ...
            raise RuntimeError(f"Geberit 146.140 official CDN evidence mismatch for {code}")
    ...
    manifest = {
        ...
        "generator": "pipeline/scripts/geberit_146_140_review.py",
