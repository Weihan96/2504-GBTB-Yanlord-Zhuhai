#!/usr/bin/env python3
"""Extract one Geberit 154.154.00.1.F IFC Body for Bonsai rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/geberit-154-154-00-1-f/Geberit-154-154-00-1-F-bonsai-isolated.ifc"
GLOBAL_ID = "2jjNIn9gHBYwNSWwlM5T_i"
...
if product is None:
    raise RuntimeError("Geberit 154.154.00.1.F representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated Geberit 154.154.00.1.F IFC lost its actual Body representation")
