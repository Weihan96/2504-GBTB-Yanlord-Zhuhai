#!/usr/bin/env python3
"""Overlay Miami Soft E07 on its complete project plan and R20 side elevation."""
...
shared.PRODUCT_DIR = ROOT / "output/review/highpoly-types/miamisoft-e07"
shared.CANDIDATE = shared.PRODUCT_DIR / "candidate-representations.json"
shared.GLOBAL_ID = "1G7iO6CfP64PjummX$qTbt"
shared.OVERLAY_ID_PREFIX = "miamisoft-e07"
shared.GENERATOR = "pipeline/scripts/render_miamisoft_e07_project_context.py"
...
def projection_group_points(source):
    ...
    if len(groups) != 1:
        raise RuntimeError(f"expected one complete Miami Soft E07 projection in {source}, found {len(groups)}")
    return groups[0]
...
if __name__ == "__main__":
    ...
    manifest["project_projection_note"] = {
        "official_nominal_mm": [1500.0, 1700.0, 800.0],
        "ifc_body_local_xyz_mm": [1543.831299, 1710.48584, 797.484863],
