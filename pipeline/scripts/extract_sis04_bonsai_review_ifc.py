#!/usr/bin/env python3
"""Extract exactly one SIS04 actual IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/sis04/sis04-bonsai-isolated.ifc"
GLOBAL_ID = "1MzM8Ms2vFo8KEm503j9w2"
...
if product is None:
    raise RuntimeError("SIS04 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated SIS04 IFC lost its actual Body representation")
