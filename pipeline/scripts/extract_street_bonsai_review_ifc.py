#!/usr/bin/env python3
"""Extract one domestic-custom STREET IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/street/antoniolupi-Street-bonsai-isolated.ifc"
GLOBAL_ID = "1FgLPMw$5B4wBH2ySMkXE1"
...
if product is None:
    raise RuntimeError("STREET representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated STREET IFC lost its actual Body representation")
