#!/usr/bin/env python3
"""Extract one RODA Bernardo 367 / TAB02 IFC Body for Bonsai review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/tab02/RODA-Bernardo-367-TAB02-bonsai-isolated.ifc"
GLOBAL_ID = "2eX84IyLr8_e34nuOoRPLQ"
...
if product is None:
    raise RuntimeError("TAB02 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated TAB02 IFC lost its actual Body representation")
