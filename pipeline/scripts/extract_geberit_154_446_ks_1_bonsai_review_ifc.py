#!/usr/bin/env python3
"""Extract one CleanLine50 IFC Body for an actual Bonsai camera render."""
...
OUTPUT = ROOT / "output/review/highpoly-types/geberit-154-446-ks-1/Geberit-154-446-KS-1-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("CleanLine50 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated CleanLine50 IFC lost its actual Body representation")
