#!/usr/bin/env python3
"""Extract one Geberit 154.154.00.1 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/geberit-154-154-00/Geberit-154-154-00-1-bonsai-isolated.ifc"
GLOBAL_ID = "14EazrLgP8whYZWY_yCuKy"
...
if product is None:
    raise RuntimeError("Geberit 154.154.00.1 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated Geberit 154.154.00.1 IFC lost its actual Body representation")
