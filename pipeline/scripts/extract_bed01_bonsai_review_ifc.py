#!/usr/bin/env python3
"""Extract one Baxter Casablanca / BED01 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/bed01/Baxter-Casablanca-BED01-bonsai-isolated.ifc"
GLOBAL_ID = "3IQBEqO5vDI8Z9k1Ltge_N"
...
if product is None:
    raise RuntimeError("BED01 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated BED01 IFC lost its actual Body representation")
