#!/usr/bin/env python3
"""Extract one Duofix Sigma IFC Body for an actual Bonsai camera render."""
...
OUTPUT = ROOT / "output/review/highpoly-types/geberit-duofix-sigma-224-212/Geberit-Duofix-Sigma-224-212-bonsai-isolated.ifc"
GLOBAL_ID = "3hgNkx97vCTOC2eewCpMNk"
...
if product is None:
    raise RuntimeError("Duofix representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated Duofix IFC lost its actual Body representation")
