#!/usr/bin/env python3
"""Extract one Gessi316 54093 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/gessi316-54093/Gessi316-54093-bonsai-isolated.ifc"
GLOBAL_ID = "1jM_suNMPAw8_nvZejQSnp"
...
if product is None:
    raise RuntimeError("Gessi316 54093 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated Gessi316 54093 IFC lost its actual Body representation")
