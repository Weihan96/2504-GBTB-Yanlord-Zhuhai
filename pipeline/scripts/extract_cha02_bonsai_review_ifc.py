#!/usr/bin/env python3
"""Extract one RODA Orson 002 / CHA02 IFC Body for Bonsai review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/cha02/RODA-Orson-002-CHA02-bonsai-isolated.ifc"
GLOBAL_ID = "3YoxxZCgbF3Ap7gztAKkcs"
...
if product is None:
    raise RuntimeError("CHA02 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated CHA02 IFC lost its actual Body representation")
