#!/usr/bin/env python3
"""Extract one Hima IFC Body for an actual Bonsai camera render."""
...
OUTPUT = ROOT / "output/review/highpoly-types/hima01/Poliform-Hima-HIMA01-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("Hima representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated Hima IFC lost its actual Body representation")
