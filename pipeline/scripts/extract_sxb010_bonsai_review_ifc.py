#!/usr/bin/env python3
"""Extract the single sxb010 kitchen proxy Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/sxb010/sxb010-bonsai-isolated.ifc"
GLOBAL_ID = "1O9JRXCI56VRUbpuLJy86Z"
...
if product is None:
    raise RuntimeError("sxb010 representative was not extracted")
...
if "Body" not in identifiers:
    raise RuntimeError("isolated sxb010 IFC lost its actual Body representation")
