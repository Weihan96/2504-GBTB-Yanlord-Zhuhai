#!/usr/bin/env python3
"""Extract one Baxter Miami Soft I03 IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/miamisoft-i03/Baxter-Miami-Soft-I03-bonsai-isolated.ifc"
GLOBAL_ID = "1hdNtfQRPCGfHLfqzdp6w0"
...
if product is None:
    raise RuntimeError("Miami Soft I03 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated Miami Soft I03 IFC lost its actual MODEL_VIEW Body representation")
