#!/usr/bin/env python3
"""Extract one Baxter Miami Soft F03 IFC Body for Bonsai camera review."""
...
OUTPUT = ROOT / "output/review/highpoly-types/miamisoft-f03/Baxter-Miami-Soft-F03-bonsai-isolated.ifc"
GLOBAL_ID = "1y3lLYK$H9fPbuh1R1vAKX"
...
if product is None:
    raise RuntimeError("Miami Soft F03 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated Miami Soft F03 IFC lost its actual MODEL_VIEW Body representation")
