#!/usr/bin/env python3
"""Extract one Baxter Beside BST02 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/bst02/Baxter-Beside-BST02-bonsai-isolated.ifc"
GLOBAL_ID = "3hA0vKpcn44u4Tsx4tqiUz"
...
if product is None:
    raise RuntimeError("BST02 representative was not extracted")
...
if not any(representation.ContextOfItems.TargetView == "MODEL_VIEW" for representation in body_representations):
    raise RuntimeError("isolated BST02 IFC lost its actual MODEL_VIEW Body representation")
