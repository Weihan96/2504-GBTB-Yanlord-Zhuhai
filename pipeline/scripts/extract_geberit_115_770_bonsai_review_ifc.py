#!/usr/bin/env python3
"""Extract exactly one Geberit Sigma01 IFC Body for Bonsai camera rendering."""
...
OUTPUT = ROOT / "output/review/highpoly-types/geberit-115-770/Geberit-115-770-bonsai-isolated.ifc"
...
if product is None:
    raise RuntimeError("Geberit representative was not extracted")
identifiers = {
    representation.RepresentationIdentifier
    for representation in product.Representation.Representations
}
if "Body" not in identifiers:
    raise RuntimeError("isolated Geberit IFC lost its actual Body representation")
