...
- `pipeline:elec-room-program`：将 22 个 Space 编译为逐房间最小功能组矩阵，并从正式设备、已分类 Proxy、WashTower 和哈希固定旧方案 A06 生成 16 个设备供电需求。当前矩阵包含 23 个控制功能组、26 个普通用电功能组、9 个弱电/数据功能组、9 个手动补充专用需求和 7 个柜体照明供电区。这些数量表示最小功能组，不是面板、插座孔、回路或端口数；设备中心也不等于最终出线位置。
