...
- `pipeline:elec-positioning-candidate`：将厨房现有 11 个插座全部映射为来源支持的用途候选：2 个冰箱、1 个直饮机、1 个烤箱、1 个炉灶、1 个油烟机、2 个 H1200 墙体/导轨电源，以及 3 个 C 面净水器/备用插座组。9 个 Proxy 同时形成 2 个冰箱体量、2 个洗碗机型号候选、1 个垃圾处理器、3 个设备孔和 1 个排烟止回阀候选；所有个体对应、功率、回路和接口仍需审核。
