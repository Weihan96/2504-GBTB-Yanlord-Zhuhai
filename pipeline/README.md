...
- `pipeline:plum-existing-candidate`：只读生成 P-201 的 27 个服务需求端点和 P-202 的 49 个既有对象定位登记。端点明确不是 `IfcDistributionPort`；当 IFC 中没有端口、系统或连接关系时报告 `data_missing`，不伪造连通性。两个 PVC110 产品继续只读识别为 6 个几何分支并以 C003 提交为世界几何冻结基线。
